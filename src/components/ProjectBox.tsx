				...
				<>
					{features && (
						<div className="flex flex-col gap-4 px-48 items-center">
							<SectionHeader title={ isInternship ? "EXPERIENCE" : "FEATURE" } />
					...
					<div className="flex flex-col gap-4 p-4 bg-primary-linear-20 border-gradient-white mx-16">
						<SectionHeader title={ isInternship ? "INTERN PICTURES" : "EXAMPLE SCREEN"} />
									...
									<>
										...
										<div className="flex gap-2 mt-4">
											{pictures.map((_, i) => (
												<div
													key={i}
													className={`w-2 h-2 rounded-full transition-opacity duration-700 ease-in-out ${
														i === currentIndex
